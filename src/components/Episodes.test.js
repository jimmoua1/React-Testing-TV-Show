...
test("Episode Component renders correctly", () => {
  ...
  expect(queryAllByTestId("episode"));
});

// Converting API Raw data JSON from https://api.tvmaze.com/singlesearch/shows?q=stranger-things&embed=episodes
// To JS version using - https://json-to-js.com/
// Copy from Episodes Array Objects.
const episodes = [
    {
      id: 553946,
